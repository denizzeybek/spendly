            ...
            <FormControl isInvalid={!!error}>
              <VStack space="md">
                ...
                <ButtonGroup space="sm" mt="$2">
                  <Button flex={1} variant={mode === 'create' ? 'solid' : 'outline'} onPress={() => setMode('create')}>
                    <ButtonText>{t('auth.createHome')}</ButtonText>
                  </Button>
                  <Button flex={1} variant={mode === 'join' ? 'solid' : 'outline'} onPress={() => setMode('join')}>
                ...
                <Button size="xl" onPress={handleRegister} isDisabled={isLoading} mt="$2">
