      ...
      <Box flex={1} bg="$backgroundLight50" sx={{ _dark: { bg: '$backgroundDark950' } }} p="$4">
        <VStack space="lg">
          <ButtonGroup space="sm">
            <Button flex={1} variant={view === 'users' ? 'solid' : 'outline'} onPress={() => setView('users')}>
              <ButtonText>{t('reports.byUser')}</ButtonText>
            </Button>
            <Button flex={1} variant={view === 'overview' ? 'solid' : 'outline'} onPress={() => setView('overview')}>
          ...
          {view === 'overview' && summary && (
            <>
              <HStack space="md">
                <Box flex={1} bg="$success100" sx={{ _dark: { bg: '$success900' } }} p="$4" borderRadius="$xl">
                ...
                <Box flex={1} bg="$error100" sx={{ _dark: { bg: '$error900' } }} p="$4" borderRadius="$xl">
          ...
          {view === 'users' && userSummaries && (
            <VStack space="md">
              {userSummaries.totalSharedExpense > 0 && (
                <Box bg="$warning100" sx={{ _dark: { bg: '$warning900' } }} p="$4" borderRadius="$xl">
                  ...
                  <VStack space="sm">
                    ...
                    >
                      <HStack justifyContent="space-between">
                        ...
                        <Text size="md" fontWeight="$bold" color={user.balance >= 0 ? '$success500' : '$error500'}>
