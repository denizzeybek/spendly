  ...
  return (
    <ScrollView style={{ flex: 1 }} contentContainerStyle={{ flexGrow: 1 }}>
      <Box flex={1} bg="$backgroundLight50" sx={{ _dark: { bg: '$backgroundDark950' } }}>
        {/* User Card */}
        <Box bg="$backgroundLight0" sx={{ _dark: { bg: '$backgroundDark900' } }} p="$4" m="$4" borderRadius="$xl">
        ...
        {/* Home Code Card */}
        <Box bg="$backgroundLight0" sx={{ _dark: { bg: '$backgroundDark900' } }} p="$4" mx="$4" mb="$4" borderRadius="$xl">
          <Text size="sm" color="$textLight500" sx={{ _dark: { color: '$textDark400' } }}>
            {t('settings.homeCode')}
          </Text>
        ...
        >
          ...
          <Pressable p="$4" onPress={() => router.push('/loans')}>
            <HStack justifyContent="space-between" alignItems="center">
              <HStack space="md" alignItems="center">
        ...
        {/* Logout Button */}
        <Box px="$4" pb="$8">
          <Button variant="outline" action="negative" size="lg" onPress={handleLogout}>
